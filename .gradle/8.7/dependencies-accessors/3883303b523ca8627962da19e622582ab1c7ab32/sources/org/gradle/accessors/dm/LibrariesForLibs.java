...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxCoreLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>androidx.ktx.core</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class MaplibreLibraryAccessors extends SubDependencyFactory {
        private final MaplibreGlLibraryAccessors laccForMaplibreGlLibraryAccessors = new MaplibreGlLibraryAccessors(owner);

        public MaplibreLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>maplibre.gl</b>
         */
        public MaplibreGlLibraryAccessors getGl() {
            return laccForMaplibreGlLibraryAccessors;
        }

    }

    public static class MaplibreGlLibraryAccessors extends SubDependencyFactory {
        private final MaplibreGlPluginLibraryAccessors laccForMaplibreGlPluginLibraryAccessors = new MaplibreGlPluginLibraryAccessors(owner);

        public MaplibreGlLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>sdk</b> with <b>org.maplibre.gl:android-sdk</b> coordinates and
         * with version reference <b>maplibre.gl</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getSdk() {
            return create("maplibre.gl.sdk");
        }

        /**
         * Group of libraries at <b>maplibre.gl.plugin</b>
         */
        public MaplibreGlPluginLibraryAccessors getPlugin() {
            return laccForMaplibreGlPluginLibraryAccessors;
        }

    }

    public static class MaplibreGlPluginLibraryAccessors extends SubDependencyFactory {
        private final MaplibreGlPluginAnnotationLibraryAccessors laccForMaplibreGlPluginAnnotationLibraryAccessors = new MaplibreGlPluginAnnotationLibraryAccessors(owner);

        public MaplibreGlPluginLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>maplibre.gl.plugin.annotation</b>
         */
        public MaplibreGlPluginAnnotationLibraryAccessors getAnnotation() {
            return laccForMaplibreGlPluginAnnotationLibraryAccessors;
        }

    }

    public static class MaplibreGlPluginAnnotationLibraryAccessors extends SubDependencyFactory {

        public MaplibreGlPluginAnnotationLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>v9</b> with <b>org.maplibre.gl:android-plugin-annotation-v9</b> coordinates and
         * with version reference <b>maplibre.gl.plugin.annotation.v9</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV9() {
            return create("maplibre.gl.plugin.annotation.v9");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final ConfigVersionAccessors vaccForConfigVersionAccessors = new ConfigVersionAccessors(providers, config);
        ...
        private final MaplibreVersionAccessors vaccForMaplibreVersionAccessors = new MaplibreVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>cmake</b> with value <b>3.22.1</b>
         * <p>
         ...
         */
        public Provider<String> getCmake() { return getVersion("cmake"); }

        /**
         * Version alias <b>ndk</b> with value <b>26.3.11579264</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getNdk() { return getVersion("ndk"); }
        ...
        /**
         * Group of versions at <b>versions.config</b>
         */
        public ConfigVersionAccessors getConfig() {
            return vaccForConfigVersionAccessors;
        }
        ...
        /**
         * Group of versions at <b>versions.maplibre</b>
         */
        public MaplibreVersionAccessors getMaplibre() {
            return vaccForMaplibreVersionAccessors;
        }
    ...
    public static class AndroidGradleVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>android.gradle.plugin</b> with value <b>8.4.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class AndroidxVersionAccessors extends VersionFactory  {
        ...
        private final AndroidxKtxVersionAccessors vaccForAndroidxKtxVersionAccessors = new AndroidxKtxVersionAccessors(providers, config);
        public AndroidxVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.androidx.ktx</b>
         */
        public AndroidxKtxVersionAccessors getKtx() {
            return vaccForAndroidxKtxVersionAccessors;
        }

    }

    public static class AndroidxKtxVersionAccessors extends VersionFactory  {

        public AndroidxKtxVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>androidx.ktx.core</b> with value <b>1.13.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCore() { return getVersion("androidx.ktx.core"); }
    ...
    public static class ComposeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>compose.activity</b> with value <b>1.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class ConfigVersionAccessors extends VersionFactory  {

        public ConfigVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>config.compileSdk</b> with value <b>34</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCompileSdk() { return getVersion("config.compileSdk"); }

        /**
         * Version alias <b>config.minSdk</b> with value <b>31</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMinSdk() { return getVersion("config.minSdk"); }

        /**
         * Version alias <b>config.targetSdk</b> with value <b>34</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTargetSdk() { return getVersion("config.targetSdk"); }
    ...
    public static class KotlinComposeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>kotlin.compose.compiler</b> with value <b>1.5.13</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCompiler() { return getVersion("kotlin.compose.compiler"); }
    ...
    public static class MaplibreVersionAccessors extends VersionFactory  {

        private final MaplibreGlVersionAccessors vaccForMaplibreGlVersionAccessors = new MaplibreGlVersionAccessors(providers, config);
        public MaplibreVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.maplibre.gl</b>
         */
        public MaplibreGlVersionAccessors getGl() {
            return vaccForMaplibreGlVersionAccessors;
        }

    }

    public static class MaplibreGlVersionAccessors extends VersionFactory  implements VersionNotationSupplier {

        private final MaplibreGlPluginVersionAccessors vaccForMaplibreGlPluginVersionAccessors = new MaplibreGlPluginVersionAccessors(providers, config);
        public MaplibreGlVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>maplibre.gl</b> with value <b>11.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> asProvider() { return getVersion("maplibre.gl"); }

        /**
         * Group of versions at <b>versions.maplibre.gl.plugin</b>
         */
        public MaplibreGlPluginVersionAccessors getPlugin() {
            return vaccForMaplibreGlPluginVersionAccessors;
        }

    }

    public static class MaplibreGlPluginVersionAccessors extends VersionFactory  {

        private final MaplibreGlPluginAnnotationVersionAccessors vaccForMaplibreGlPluginAnnotationVersionAccessors = new MaplibreGlPluginAnnotationVersionAccessors(providers, config);
        public MaplibreGlPluginVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.maplibre.gl.plugin.annotation</b>
         */
        public MaplibreGlPluginAnnotationVersionAccessors getAnnotation() {
            return vaccForMaplibreGlPluginAnnotationVersionAccessors;
        }

    }

    public static class MaplibreGlPluginAnnotationVersionAccessors extends VersionFactory  {

        public MaplibreGlPluginAnnotationVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>maplibre.gl.plugin.annotation.v9</b> with value <b>3.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getV9() { return getVersion("maplibre.gl.plugin.annotation.v9"); }
    ...
    public static class PlayServicesVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>play.services.location</b> with value <b>21.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
